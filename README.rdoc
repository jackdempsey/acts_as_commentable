...
Provides a single Comment model that can be added to any model(s) within your app.  It creates a
Comment model and handles the plumbing between that model and any models that you declare to be
commentable models.
